...
void asymmetry(const char* fname="sim_tree.root", const char* tname="tree")
{
  ...
  tree->Project("h1_x2"    , "dim_true.x2"               , "dim_true.pdg_id==443 && rec_stat==0");
  //tree->Project("h1_m"     , "dim_true.mom.M()"          , "dim_true.pdg_id==443 && rec_stat==0");
  tree->Project("h2_phi_x2", "dim_true.x2:dim_true.phi_s", "dim_true.pdg_id==443 && rec_stat==0");
  //tree->Project("h2_phi_x2", "dim_true.x2:dim_true.phi_s_up", "dim_true.pdg_id==443 && rec_stat==0");
