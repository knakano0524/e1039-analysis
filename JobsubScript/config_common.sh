...
# An absolute path or a relative path to $DIR_SCRIPT.
...
# FN_EXE_SIN:  Name of the script that runs a single parameter set.
# User need not change usually.
FN_EXE_SIN=execute_single.sh

# FN_CONF_NG_SITE:  Name of list of NG site for job submission.
# User need not change usually.
FN_CONF_NG_SITE=~kenichi/e1039/jobsub_ng_site.txt
